                ...
                return isMobile
                    ...
                    : Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(flex: 4, child: _buildLeftFormContainer(false)),
                            const SizedBox(width: 20),
                            Expanded(flex: 6, child: _buildRightMapPlaceholder(false)),
                          ],
                        ),
                      );
              },
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (value) =>
                  value == null || value.isEmpty ? 'Please enter your enquiry message' : null,
            ),
            const SizedBox(height: 20),
            ElevatedButton(
              ...
              child: const Text('Submit Enquiry', style: TextStyle(fontSize: 16, color: Colors.black)),
            ),
          ],
        ),
      ),
